...
""", unsafe_allow_html=True)
    ...
    if st.button("Predict", key="btn_manual"):
        ...
        # ============================================================
        st.warning("""
        Hasil ini hanyalah prediksi berbasis Machine Learning dan bukan diagnosis medis.

        ⚠️ Sangat disarankan untuk tetap berkonsultasi dengan dokter atau tenaga medis profesional 
        untuk pemeriksaan lebih lanjut dan memastikan kondisi kesehatan Anda.
        """)

        st.info("💡 Tips: Jaga pola makan, olahraga rutin, dan cek kesehatan secara berkala.")
